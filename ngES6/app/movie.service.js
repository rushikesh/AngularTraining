...
var MovieService = exports.MovieService = function () {
  ...
  _createClass(MovieService, [{
    ...
    key: "generateRandomMovie",
    value: function generateRandomMovie(delay, callback) {
      var _this = this;

      setInterval(function () {
        return callback(_this.getMovie());
      }, delay);
    }
  }]);
...
var movieList = [{
  ...
  name: "The Prestige",
  runtime: "130 min",
  synopsis: "After a tragic accident two stage magicians engage in a battle to create the ultimate illusion whilst sacrificing everything they have to outwit the other."
}, {
  name: "Apocalypse Now",
  runtime: "147 min",
